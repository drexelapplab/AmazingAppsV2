//:![ExCITe Center Logo?](logos/excite-logo-small.png)
//:# Amazing Apps
//:
...
var myTemp = 99.1
//:
//: Programs can include **comments** that explain the code or provide a reminder to fix something. Comments do not get run by the program.  See the comment for the *screenWidth* variable below. The comment helps the programmer understand the measurements being used. Use the double forward slashes to make a comment. "//"
...
//: Look at the **syntax** of the different statements.  Although all languages will have a variation of an if/else statement, they will vary on how to format it.  Some may not require parentheses and some may require that the brackets all align in a certain way.
//:
//:
//: [Next](@next)
